    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            if (faults == 0)
            {
                ...
                User userToAdd = new User() { Username = username, Password = password, Mail = email, Picture = "http://vignette3.wikia.nocookie.net/peido/images/a/a1/Fsjal_spongebob.png/revision/latest?cb=20110801205739", Amount = 1000, Deposit = 0, Withdrawal = 0 };
